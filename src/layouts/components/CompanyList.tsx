...
const CompanyList = () => {
  ...
  const handleCompanyClick = (companyId: string) => {
    ...
    window.location.href = `http://${host}/company-details/${companyId}`;
  };
        ...
        <div className="row items-center justify-between">
          <div className="flex flex-wrap justify-between items-center w-full">
            {empresas.map((empresa: any) => (
              <div onClick={() => handleCompanyClick(empresa.company_id)} className="w-full md:w-1/2 lg:w-1/3 p-4 flex items-start max-h-28" key={empresa.company_id}>
                <div className="mr-4">
